...
def parse_args(train=True):
    ...
    pose_mode = 0
    opts, args = getopt(sys.argv[1:],'g:n:c:o:b:p:',['gpu=','name=','checkpoint=','object=','body=','pose_mode='])
    ...
    return gpu_id, name, object, body, checkpoint, pose_mode
